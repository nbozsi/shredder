...
The aspect ratio of the small rectangles will be ```2*W : H```, the number of stripes has zero impact on this, (with a photo twice as high as wide, the small rectangles will be squares).  
**Table of Contents**
